...
namespace agents_function_app03;
...
public class get_weather_azure_function01
{
    ...
    public string Run(
        [QueueTrigger("azure-function-foo-input", Connection = "AzureWebJobsStorage")] QueueMessage message
    )
    {
        _logger.LogInformation("C# Queue trigger function processed: {messageText}", message.MessageText.ToUpper());
